    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'L', (uint8)'P', (uint8)'M', (uint8)' ', (uint8)'S', (uint8)'e', (uint8)'l', (uint8)'e', (uint8)'c', (uint8)'t', 
    ...
    (uint8)'L', (uint8)'P', (uint8)'M', (uint8)' ', (uint8)'S', (uint8)'E', (uint8)'L', (uint8)' ', (uint8)'C', (uint8)'o',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[24] }, /* LPM SEL Control */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x10u] = {
    ...
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00001801u /* wr,ntf */, 0x0010u, {{0xCBB1u, NULL}}                           },
    { 0x000Eu, 0xCBB1u /* LPM SEL Control                     */, 0x00011802u /* wr,ntf */, 0x0010u, {{0x0001u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x00010004u /*        */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
